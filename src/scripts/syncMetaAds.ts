...
function mapInsight(row: MetaAdInsight, syncedAt: string) {
  ...
  return {
    ...
    video_p95_watched_actions: Math.round(metricValue(row.video_p95_watched_actions)),
    video_p100_watched_actions: Math.round(metricValue(row.video_p100_watched_actions)),
    video_continuous_2_sec_watched_actions: Math.round(metricValue(row.video_continuous_2_sec_watched_actions)),
    video_15_sec_watched_actions: Math.round(metricValue(row.video_15_sec_watched_actions)),
    video_30_sec_watched_actions: Math.round(metricValue(row.video_30_sec_watched_actions)),
    video_thruplay_watched_actions: Math.round(metricValue(row.video_thruplay_watched_actions)),
