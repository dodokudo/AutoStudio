  ...
  await client.query({
    query: `
      ...
      WHEN NOT MATCHED THEN
        INSERT (id, target_month, working_days, target_revenue, target_line_registrations, target_seminar_participants, target_frontend_purchases, target_backend_purchases, created_at, updated_at)
        VALUES (S.id, S.target_month, S.working_days, S.target_revenue, S.target_line_registrations, S.target_seminar_participants, S.target_frontend_purchases, S.target_backend_purchases, S.created_at, S.updated_at)
    `,
    params: {
      id,
