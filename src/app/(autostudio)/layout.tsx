        ...
        <div className="rounded-3xl border border-white/60 bg-white/70 p-4 shadow-[0_20px_45px_rgba(125,145,211,0.25)] backdrop-blur-2xl dark:border-white/10 dark:bg-white/10">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <Link href="/threads" className="flex items-center gap-3 text-lg font-semibold text-slate-900 transition hover:text-indigo-600 dark:text-white">
              <span className="relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-500 to-sky-400 shadow-[0_18px_38px_rgba(91,124,255,0.28)]">
                <Image src="/autostudio-logo.svg" alt="AutoStudio" width={44} height={44} className="h-full w-full object-cover" priority />
              </span>
