    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="metrics">
                ...
                <div class="metric-card">
                    <div class="metric-label">LINE登録（Threads経由）</div>
                    <div class="metric-value">${data.summary.lineRegistrations}件</div>
                    <div class="metric-sub">CVR ${(data.summary.lineRegistrations / data.summary.totalImpressions * 100).toFixed(3)}%</div>
                </div>
            </div>
            ...
            <div class="success-box" style="margin-top: 30px;">
                ...
                <ul style="margin-left: 20px; line-height: 2;">
                    ...
                    <li>最大バズ投稿：270,000 imp + フォロワー303人増 + LINE登録31件（10月4日）</li>
        ...
        <!-- 2. 日別推移 -->
        <section>
            <h2>📈 日別推移（インプレッション・フォロワー・LINE登録）</h2>
...
${generateMonthlySection(data.monthlyBreakdown)}
    ...
    const dailyLineRegistrations = dailySummary.map(d => d.lineThreads);
        ...
        options: {
            ...
            scales: {
                ...
                y1: {
                    ...
                    position: 'right',
                    min: 0,
                    title: { display: true, text: 'フォロワー増加 / LINE登録' },
  ...
  await writeFile(
    path.join(__dirname, '../public/analysis/threads/レポート_10月11月_完全版.html'),
    html,
    'utf8'
  );
  console.log('✅ Full report generated: レポート_10月11月_完全版.html');
}
